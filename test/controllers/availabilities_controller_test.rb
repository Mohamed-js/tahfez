...
class AvailabilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create availability" do
    assert_difference('Availability.count') do
      post availabilities_url, params: { availability: { day: @availability.day, occupied: @availability.occupied, student_id_id: @availability.student_id_id, teacher_id_id: @availability.teacher_id_id, time: @availability.time } }
    end
  ...
  test "should update availability" do
    patch availability_url(@availability), params: { availability: { day: @availability.day, occupied: @availability.occupied, student_id_id: @availability.student_id_id, teacher_id_id: @availability.teacher_id_id, time: @availability.time } }
